        ...
        <div className='tw-h-full tw-flex tw-justify-center tw-flex-col tw-items-center'>
            <div className='tw-grid tw-grid-cols-2 tw-place-items-center tw-w-full'>
                <div className='tw-flex tw-flex-col tw-items-center tw-w-full'>
                    <input type="text" name="first_name" required={true} value={data.first_name} onChange={(e)=>setData({...data, [e.target.name] : e.target.value})} placeholder='First Name*' className='tw-border-gray-300 tw-border-2 tw-px-4 tw-py-2 focus:tw-outline-none tw-rounded-sm tw-w-4/5 tw-my-2'/>
                    <input type="text" name="last_name" required={true} value={data.last_name} onChange={(e)=>setData({...data, [e.target.name] : e.target.value})} placeholder='Last Name*' className='tw-border-gray-300 tw-border-2 tw-px-4 tw-py-2 focus:tw-outline-none tw-rounded-sm tw-w-4/5 tw-my-2'/>
